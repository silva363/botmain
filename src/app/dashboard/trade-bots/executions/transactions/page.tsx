...
export default function Transactions() {
    ...
    const getTransactions = async () => {
      try {
        const response = await axios.post(
          `${process.env.NEXT_PUBLIC_BASE_APP_URL}/api/trade-bot/executions/transactions`,
          {
            authtoken: token,
  ...
  const handleAirdropClick = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_APP_URL}/api/trade-bot/executions/transactions/airdrop`, { id, authtoken: token },
      );
