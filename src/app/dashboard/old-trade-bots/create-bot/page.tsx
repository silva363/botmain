...
const Listagem = () => {
  ...
  const handleSave = async (e: any) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.NEXT_PUBLIC_BASE_APP_URL}/api/old-trade-bot/create`, {
        formData,
        authtoken: token
      });
      ...
      if (response.data.success) {
        ...
        push("/dashboard/old-trade-bots/list");
      } else {
        ...
        (
          ...
          <div className="form-style">
            ...
            <form onSubmit={handleSave}>
              ...
              <Separator />
              <BlocoBtn>
                <Link href="/dashboard/old-trade-bots/list">
