...
export default function Executions() {
    ...
    const getExecutions = async () => {
      try {
        const response = await axios.post(
          `${process.env.NEXT_PUBLIC_BASE_APP_URL}/api/old-trade-bot/executions`,
          {
            authtoken: token,
            uuid: idParams,
            page: pagination,
  ...
  const pageTransactions = (id: number) => {
    push(`/dashboard/old-trade-bots/executions/transactions?id=${id}&uuid=${idParams}&name=${botName}&type=${botType}`);
  };
